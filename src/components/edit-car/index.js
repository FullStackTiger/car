...
import { editCarList } from "../../store/cars/actions";
...
export function EditCarModal({
  ...
  const onSubmit = (data) => {
    dispatch(editCarList({ ...data, id }));
    closeModal();
    notify(`The ${data.car_name} car has been updated!`);
  };
  ...
  return (
    <Modal
      ...
      className="edit-car__modal"
      overlayClassName="add-car__overlay"
    >
      <div className="edit-car__title">
        <div>Edit Car</div>
        <button onClick={closeModal}>X</button>
      </div>
      <form onSubmit={handleSubmit(onSubmit)} className="edit-car__form">
        <div className="field">
